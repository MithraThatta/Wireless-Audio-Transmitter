...
/* USER CODE BEGIN PV */
#define ADC_Buf_Size 96 //48 samples per ms * 2 bytes per sample = 96
...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
 // ADC1->IER |= (1U<<2); //enables EOC, end of conversion, interrupts


  HAL_TIM_Base_Start(&htim6);
  HAL_ADC_Start_DMA(&hadc1, (uint32_t*)adcBuf, ADC_Buf_Size);
